 ...
 * @property {number} gid The numeric group identifier of the group that owns the file.
 * @property {number} mode A bit-field describing the file type and mode.
 * @property {number} uid The numeric user identifier of the user that owns the file.
 */
